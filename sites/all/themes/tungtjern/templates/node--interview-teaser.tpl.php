<section class="pure-g interview interview-teaser row teaser<?php print get_edit_classes($node); ?>">
  ...
  <?php endif; ?>
      <p class="post-meta">
        ...
        <span class="author">
          <i class="fa fa-user"></i> Interviewet af <?php print ($node->uid > 0) ? l($node->name, 'user/' . $node->uid) : t('Anonymous'); ?>,
